...
class Installer(object):
    ...
    def _auto_user(self, python):
        ...
        This should be True for system Python, and False in an venv.
        """
        ...
        if not user_site:
            ...
            log.debug('User site packages not available - venv install')
            return False
    ...
    def install_reqs_my_python_if_needed(self):
        ...
        try:
            ...
            log.warning("Installing requirements to Flit's venv to import module.")
