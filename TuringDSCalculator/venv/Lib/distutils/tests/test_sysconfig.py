...
class SysconfigTestCase(support.EnvironGuard, unittest.TestCase):
    ...
    def test_customize_compiler(self):
        ...
        os.environ['CXX'] = 'env_cxx --venv-cxx-flags'
        os.environ['LDSHARED'] = 'env_ldshared'
        os.environ['LDFLAGS'] = '--venv-ldflags'
        os.environ['ARFLAGS'] = '--venv-arflags'
        os.environ['CFLAGS'] = '--venv-cflags'
        os.environ['CPPFLAGS'] = '--venv-cppflags'

        comp = self.customize_compiler()
        self.assertEqual(comp.exes['archiver'],
                         'env_ar --venv-arflags')
        self.assertEqual(comp.exes['preprocessor'],
                         'env_cpp --venv-cppflags')
        self.assertEqual(comp.exes['compiler'],
                         'env_cc --sc-cflags --venv-cflags --venv-cppflags')
        self.assertEqual(comp.exes['compiler_so'],
                         ('env_cc --sc-cflags '
                          '--venv-cflags ''--venv-cppflags --sc-ccshared'))
        self.assertEqual(comp.exes['compiler_cxx'],
                         'env_cxx --venv-cxx-flags')
        self.assertEqual(comp.exes['linker_exe'],
                         'env_cc')
        self.assertEqual(comp.exes['linker_so'],
                         ('env_ldshared --venv-ldflags --venv-cflags'
                          ' --venv-cppflags'))
